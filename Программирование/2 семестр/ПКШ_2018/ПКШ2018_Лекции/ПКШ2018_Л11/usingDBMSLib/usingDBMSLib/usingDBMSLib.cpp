...
в качестве параметра передается "относительный" путь к файлу. Эти методы зависят от 
способа хранения данных в файле.
...
void main()
{
	...
	cout<<"Введите имя БД\n";//обратить внимание на удобство тестирования
