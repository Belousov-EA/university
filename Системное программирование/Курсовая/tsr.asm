...
;
; Авторы:
;  МГТУ им. Н.Э. Баумана, ИУ5-81, 2021 г.
;   Белоусов Е.А.
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
code segment	'code'
	...
	; данные
	replaceWith                     DB  'QWERTYUIOP{}ASDFGHJKL:"ZXCVBNM<>'
	ignoredChars 					DB	'ЙЦУКЕНГШЩЗХЪФЫВАПРОЛДЖЭЯЧСМИТЬБЮ'	;@ список игнорируемых символов
	ignoredLength 				equ	$-ignoredChars				; длина строки ignoredChars
	ignoreEnabled 				DB	0							; флаг функции игнорирования ввода
	translateFrom 				DB	'T:PBR'						;@ символы для замены (АБВГД на англ. раскладке)
	...
	signatureLine1				DB	179, 'Белоусов Евгений                                  ', 179
	Line1_length 					equ	$-signatureLine1
	signatureLine2				DB	179, 'ИУ5-81                                            ', 179
	...
	helpMsg DB '>tsr.com [/?]', 10, 13
			...
			DB '  F1  - вывод ФИО и группы по таймеру вверху экрана', 10, 13
			DB '  F2  - включение и отключения курсивного вывода русского символа Б', 10, 13
			DB '  F3  - включение и отключение частичной русификации клавиатуры(T:PBR -> ЕЖЗИК)', 10, 13
			DB '  F4  - включение и отключение режима множества русских букв на множество букв латинских', 10, 13
