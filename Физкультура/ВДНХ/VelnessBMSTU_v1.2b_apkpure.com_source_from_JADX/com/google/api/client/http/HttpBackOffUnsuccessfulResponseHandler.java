...
public class HttpBackOffUnsuccessfulResponseHandler implements HttpUnsuccessfulResponseHandler {
    ...
    public interface BackOffRequired {
        public static final BackOffRequired ALWAYS = new C05621();
        public static final BackOffRequired ON_SERVER_ERROR = new C05632();

        static class C05621 implements BackOffRequired {
            C05621() {
            }
        ...
        static class C05632 implements BackOffRequired {
            C05632() {
            }
