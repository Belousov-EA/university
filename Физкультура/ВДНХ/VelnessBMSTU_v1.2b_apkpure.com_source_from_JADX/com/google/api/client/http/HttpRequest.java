...
public final class HttpRequest {
    ...
    class C02611 implements Callable<HttpResponse> {
        C02611() {
        }
        ...
        do {
            ...
            if (!this.suppressUserAgentSuffix) {
                if (originalUserAgent == null) {
                    ...
                    String valueOf = String.valueOf(String.valueOf(originalUserAgent));
            ...
            if (streamingContent != null) {
                ...
                if (loggable) {
                    ...
                    if (contentType != null) {
                        str = "Content-Type: ";
                        valueOf = String.valueOf(contentType);
                        if (valueOf.length() != 0) {
                            header = str.concat(valueOf);
                        } else {
                            str2 = new String(str);
                        }
                        logbuf.append(header).append(StringUtils.LINE_SEPARATOR);
                        if (curlbuf != null) {
                            str = String.valueOf(String.valueOf(header));
                            curlbuf.append(new StringBuilder(str.length() + 6).append(" -H '").append(str).append("'").toString());
                        }
                    }
                    if (contentEncoding != null) {
                        str = "Content-Encoding: ";
                        valueOf = String.valueOf(contentEncoding);
                        if (valueOf.length() != 0) {
                            header = str.concat(valueOf);
                        } else {
                            str2 = new String(str);
    ...
    public Future<HttpResponse> executeAsync(Executor executor) {
        FutureTask<HttpResponse> future = new FutureTask(new C02611());
