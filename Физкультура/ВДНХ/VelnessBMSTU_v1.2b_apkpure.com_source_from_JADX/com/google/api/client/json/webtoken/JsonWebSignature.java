...
public class JsonWebSignature extends JsonWebToken {
    ...
    public static String signUsingRsaSha256(PrivateKey privateKey, JsonFactory jsonFactory, Header header, Payload payload) throws GeneralSecurityException, IOException {
        ...
        String content = new StringBuilder((valueOf.length() + 1) + valueOf2.length()).append(valueOf).append(".").append(valueOf2).toString();
        ...
        valueOf = String.valueOf(String.valueOf(content));
        valueOf2 = String.valueOf(String.valueOf(Base64.encodeBase64URLSafeString(signature)));
