...
public class ArrayMap<K, V> extends AbstractMap<K, V> implements Cloneable {
    ...
    public static <K, V> ArrayMap<K, V> of(Object... keyValuePairs) {
        ...
        if (1 == length % 2) {
            String valueOf = String.valueOf(String.valueOf(keyValuePairs[length - 1]));
            throw new IllegalArgumentException(new StringBuilder(valueOf.length() + 28).append("missing value for last key: ").append(valueOf).toString());
        }
