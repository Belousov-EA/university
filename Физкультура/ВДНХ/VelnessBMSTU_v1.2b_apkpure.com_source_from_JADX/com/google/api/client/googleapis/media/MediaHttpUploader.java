...
*/
    ...
    private void setContentAndHeadersOnCurrentRequest() throws IOException {
        ...
        headers2.setContentRange(new StringBuilder(valueOf2.length() + 48).append("bytes ").append(j).append("-").append(j2).append("/").append(valueOf2).toString());
    }
    ...
    public MediaHttpUploader setChunkSize(int chunkSize) {
        boolean z = chunkSize > 0 && chunkSize % 262144 == 0;
