...
public class TokenRequest extends GenericData {
    ...
    class C05601 implements HttpRequestInitializer {
        C05601() {
        }
    ...
    public final HttpResponse executeUnparsed() throws IOException {
        HttpRequest request = this.transport.createRequestFactory(new C05601()).buildPostRequest(this.tokenServerUrl, new UrlEncodedContent(this));
