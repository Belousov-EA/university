...
public final class InetAddresses {
    ...
    public static final class TeredoInfo {
        ...
        public TeredoInfo(@Nullable Inet4Address server, @Nullable Inet4Address client, int port, int flags) {
            ...
            if (flags < 0 || flags > SupportMenu.USER_MASK) {
                z = false;
            } else {
                z = true;
            }
    ...
    public static boolean is6to4Address(Inet6Address ip) {
        byte[] bytes = ip.getAddress();
        if (bytes[0] == (byte) 32 && bytes[1] == (byte) 2) {
            return true;
        }
        return false;
    }
    ...
    public static boolean isTeredoAddress(Inet6Address ip) {
        byte[] bytes = ip.getAddress();
        if (bytes[0] == (byte) 32 && bytes[1] == (byte) 1 && bytes[2] == (byte) 0 && bytes[3] == (byte) 0) {
            return true;
        }
        return false;
    }
    ...
    public static TeredoInfo getTeredoInfo(Inet6Address ip) {
        ...
        int port = (ByteStreams.newDataInput(bytes, 10).readShort() ^ -1) & SupportMenu.USER_MASK;
    ...
    public static boolean isIsatapAddress(Inet6Address ip) {
        ...
        byte[] bytes = ip.getAddress();
        if ((bytes[8] | 3) == 3 && bytes[9] == (byte) 0 && bytes[10] == (byte) 94 && bytes[11] == (byte) -2) {
            return true;
        }
        return false;
    }
