...
public final class MediaType {
    ...
    class C07421 implements Function<Collection<String>, ImmutableMultiset<String>> {
        C07421() {
        }
    ...
    class C07432 implements Function<String, String> {
        C07432() {
        }
    ...
    private Map<String, ImmutableMultiset<String>> parametersAsMap() {
        return Maps.transformValues(this.parameters.asMap(), new C07421());
    }
    ...
    public String toString() {
        ...
        if (!this.parameters.isEmpty()) {
            builder.append("; ");
            PARAMETER_JOINER.appendTo(builder, Multimaps.transformValues(this.parameters, new C07432()).entries());
        }
