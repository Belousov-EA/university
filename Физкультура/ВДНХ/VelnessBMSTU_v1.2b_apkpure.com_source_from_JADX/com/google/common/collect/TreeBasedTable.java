...
public class TreeBasedTable<R, C, V> extends StandardRowSortedTable<R, C, V> {
    ...
    class C07171 implements Function<Map<C, V>, Iterator<C>> {
        C07171() {
        }
    ...
    Iterator<C> createColumnKeyIterator() {
        ...
        final Iterator<C> merged = Iterators.mergeSorted(Iterables.transform(this.backingMap.values(), new C07171()), comparator);
