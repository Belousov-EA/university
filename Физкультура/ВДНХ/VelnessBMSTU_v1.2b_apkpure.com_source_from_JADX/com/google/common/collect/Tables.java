...
public final class Tables {
    private static final Function<? extends Map<?, ?>, ? extends Map<?, ?>> UNMODIFIABLE_WRAPPER = new C07121();

    static class C07121 implements Function<Map<Object, Object>, Map<Object, Object>> {
        C07121() {
        }
    ...
    private static class TransformedTable<R, C, V1, V2> extends AbstractTable<R, C, V2> {
        ...
        class C07131 implements Function<Cell<R, C, V1>, Cell<R, C, V2>> {
            C07131() {
            }
        ...
        class C07142 implements Function<Map<C, V1>, Map<C, V2>> {
            C07142() {
            }
        ...
        class C07153 implements Function<Map<R, V1>, Map<R, V2>> {
            C07153() {
            }
        ...
        public Map<R, Map<C, V2>> rowMap() {
            return Maps.transformValues(this.fromTable.rowMap(), new C07142());
        }

        public Map<C, Map<R, V2>> columnMap() {
            return Maps.transformValues(this.fromTable.columnMap(), new C07153());
        }
    }

    private static class TransposeTable<C, R, V> extends AbstractTable<C, R, V> {
        private static final Function<Cell<?, ?, ?>, Cell<?, ?, ?>> TRANSPOSE_CELL = new C07161();
        final Table<R, C, V> original;

        static class C07161 implements Function<Cell<?, ?, ?>, Cell<?, ?, ?>> {
            C07161() {
            }
