...
public final class Multisets {
    private static final Ordering<Entry<?>> DECREASING_COUNT_ORDERING = new C06895();
    ...
    static class C06895 extends Ordering<Entry<?>> {
        C06895() {
        }
    ...
    private static final class FilteredMultiset<E> extends AbstractMultiset<E> {
        ...
        class C06911 implements Predicate<Entry<E>> {
            C06911() {
            }
        ...
        Set<Entry<E>> createEntrySet() {
            return Sets.filter(this.unfiltered.entrySet(), new C06911());
        }
