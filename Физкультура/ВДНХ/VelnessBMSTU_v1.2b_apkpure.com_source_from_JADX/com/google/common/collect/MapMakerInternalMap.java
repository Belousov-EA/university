...
class MapMakerInternalMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable {
    ...
    static final Queue<? extends Object> DISCARDING_QUEUE = new C03242();
    static final int DRAIN_MAX = 16;
    static final int DRAIN_THRESHOLD = 63;
    static final int MAXIMUM_CAPACITY = 1073741824;
    static final int MAX_SEGMENTS = 65536;
    static final ValueReference<Object, Object> UNSET = new C06581();
    ...
    static class C03242 extends AbstractQueue<Object> {
        C03242() {
        }
    ...
    static final class EvictionQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C09341();

        class C09341 extends AbstractReferenceEntry<K, V> {
    ...
    static final class ExpirationQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C09361();

        class C09361 extends AbstractReferenceEntry<K, V> {
    ...
    static class Segment<K, V> extends ReentrantLock {
        ...
        Segment(MapMakerInternalMap<K, V> map, int initialCapacity, int maxSegmentSize) {
            ...
            Queue concurrentLinkedQueue = (map.evictsBySize() || map.expiresAfterAccess()) ? new ConcurrentLinkedQueue() : MapMakerInternalMap.discardingQueue();
    ...
    static class C06581 implements ValueReference<Object, Object> {
        C06581() {
        }
