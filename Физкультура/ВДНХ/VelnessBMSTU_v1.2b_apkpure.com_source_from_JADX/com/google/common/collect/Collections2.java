...
public final class Collections2 {
    ...
    private static class PermutationIterator<E> extends AbstractIterator<List<E>> {
        ...
        PermutationIterator(List<E> list) {
            ...
            this.f27c = new int[n];
            this.f29o = new int[n];
            Arrays.fill(this.f27c, 0);
            Arrays.fill(this.f29o, 1);
        }
        ...
        void calculateNextPermutation() {
            this.f28j = this.list.size() - 1;
            int s = 0;
            if (this.f28j != -1) {
                while (true) {
                    int q = this.f27c[this.f28j] + this.f29o[this.f28j];
                    if (q < 0) {
                        switchDirection();
                    } else if (q != this.f28j + 1) {
                        Collections.swap(this.list, (this.f28j - this.f27c[this.f28j]) + s, (this.f28j - q) + s);
                        this.f27c[this.f28j] = q;
                        return;
                    } else if (this.f28j != 0) {
                        s++;
                        switchDirection();
        ...
        void switchDirection() {
            this.f29o[this.f28j] = -this.f29o[this.f28j];
            this.f28j--;
        }
    }
