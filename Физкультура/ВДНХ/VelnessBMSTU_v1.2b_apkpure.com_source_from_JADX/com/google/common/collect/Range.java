...
public final class Range<C extends Comparable> implements Predicate<C>, Serializable {
    ...
    private static final Function<Range, Cut> LOWER_BOUND_FN = new C06941();
    static final Ordering<Range<?>> RANGE_LEX_ORDERING = new C06963();
    private static final Function<Range, Cut> UPPER_BOUND_FN = new C06952();
    private static final long serialVersionUID = 0;
    final Cut<C> lowerBound;
    final Cut<C> upperBound;

    static class C06941 implements Function<Range, Cut> {
        C06941() {
        }
    ...
    static class C06952 implements Function<Range, Cut> {
        C06952() {
        }
    ...
    static class C06963 extends Ordering<Range<?>> {
        C06963() {
        }
