...
public final class Multimaps {
    ...
    static final class AsMap<K, V> extends ImprovedAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends EntrySet<K, Collection<V>> {
            ...
            class C06841 implements Function<K, Collection<V>> {
                C06841() {
                }
            ...
            public Iterator<Entry<K, Collection<V>>> iterator() {
                return Maps.asMapEntryIterator(AsMap.this.multimap.keySet(), new C06841());
            }
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(final K key) {
            return new ImprovedAbstractSet<V>() {
                ...
                class C03261 implements Iterator<V> {
                    int f12i;
                    ...
                    public boolean hasNext() {
                        return this.f12i == 0 && MapMultimap.this.map.containsKey(key);
                    }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        class C06871 implements EntryTransformer<K, Collection<V1>, Collection<V2>> {
            C06871() {
            }
        ...
        Map<K, Collection<V2>> createAsMap() {
            return Maps.transformEntries(this.fromMultimap.asMap(), new C06871());
        }
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        class C06881 implements Function<Collection<V>, Collection<V>> {
            C06881() {
            }
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            result = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new C06881()));
            this.map = result;
            return result;
        }
