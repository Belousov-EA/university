...
public final class ByteStreams {
    ...
    private static final OutputStream NULL_OUTPUT_STREAM = new C03511();

    static class C03511 extends OutputStream {
        C03511() {
        }
    ...
    static class C07322 implements Function<InputSupplier<? extends InputStream>, ByteSource> {
        C07322() {
        }
    ...
    public static InputSupplier<InputStream> join(Iterable<? extends InputSupplier<? extends InputStream>> suppliers) {
        ...
        return asInputSupplier(ByteSource.concat(Iterables.transform(suppliers, new C07322())));
    }
