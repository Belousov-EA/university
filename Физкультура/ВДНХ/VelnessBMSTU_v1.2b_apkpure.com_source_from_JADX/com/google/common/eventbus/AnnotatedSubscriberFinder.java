...
class AnnotatedSubscriberFinder implements SubscriberFindingStrategy {
    private static final LoadingCache<Class<?>, ImmutableList<Method>> subscriberMethodsCache = CacheBuilder.newBuilder().weakKeys().build(new C07261());
    ...
    static class C07261 extends CacheLoader<Class<?>, ImmutableList<Method>> {
        C07261() {
        }
