...
public class EventBus {
    private static final LoadingCache<Class<?>, Set<Class<?>>> flattenHierarchyCache = CacheBuilder.newBuilder().weakKeys().build(new C07271());
    ...
    class C03432 extends ThreadLocal<Queue<EventWithSubscriber>> {
        C03432() {
        }
    ...
    class C03443 extends ThreadLocal<Boolean> {
        C03443() {
        }
    ...
    static class C07271 extends CacheLoader<Class<?>, Set<Class<?>>> {
        C07271() {
        }
    ...
    public EventBus(SubscriberExceptionHandler subscriberExceptionHandler) {
        ...
        this.eventsToDispatch = new C03432();
        this.isDispatching = new C03443();
