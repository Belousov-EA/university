...
public final class Functions {
    ...
    private static class FunctionComposition<A, B, C> implements Function<A, C>, Serializable {
        private static final long serialVersionUID = 0;
        private final Function<A, ? extends B> f21f;
        private final Function<B, C> f22g;

        public FunctionComposition(Function<B, C> g, Function<A, ? extends B> f) {
            this.f22g = (Function) Preconditions.checkNotNull(g);
            this.f21f = (Function) Preconditions.checkNotNull(f);
        }

        public C apply(@Nullable A a) {
            return this.f22g.apply(this.f21f.apply(a));
        }
        ...
        public boolean equals(@Nullable Object obj) {
            ...
            if (this.f21f.equals(that.f21f) && this.f22g.equals(that.f22g)) {
                return true;
            }
            return false;
        }
        ...
        public int hashCode() {
            return this.f21f.hashCode() ^ this.f22g.hashCode();
        }

        public String toString() {
            return this.f22g + "(" + this.f21f + ")";
        }
    }
