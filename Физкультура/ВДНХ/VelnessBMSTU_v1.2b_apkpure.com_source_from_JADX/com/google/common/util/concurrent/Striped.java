...
public abstract class Striped<L> {
    ...
    private static final Supplier<ReadWriteLock> READ_WRITE_LOCK_SUPPLIER = new C08035();
    ...
    static class C07991 implements Supplier<Lock> {
        C07991() {
        }
    ...
    static class C08002 implements Supplier<Lock> {
        C08002() {
        }
    ...
    static class C08035 implements Supplier<ReadWriteLock> {
        C08035() {
        }
    ...
    public static Striped<Lock> lock(int stripes) {
        return new CompactStriped(stripes, new C07991());
    }

    public static Striped<Lock> lazyWeakLock(int stripes) {
        return lazy(stripes, new C08002());
    }
