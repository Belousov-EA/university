...
public final class ServiceManager {
    ...
    private static final class ServiceManagerState {
        ...
        boolean ready;
        @GuardedBy("monitor")
        final SetMultimap<State, Service> servicesByState = Multimaps.newSetMultimap(new EnumMap(State.class), new C07941());
        @GuardedBy("monitor")
        ...
        class C07941 implements Supplier<Set<Service>> {
            C07941() {
            }
        ...
        class C07974 implements Function<Entry<Service, Long>, Long> {
            C07974() {
            }
        ...
        ImmutableMap<Service, Long> startupTimes() {
            ...
            try {
                ...
                Collections.sort(loadTimes, Ordering.natural().onResultOf(new C07974()));
