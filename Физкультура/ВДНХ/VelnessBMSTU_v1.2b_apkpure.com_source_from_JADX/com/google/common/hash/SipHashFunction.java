...
final class SipHashFunction extends AbstractStreamingHashFunction implements Serializable {
    ...
    private static final class SipHasher extends AbstractStreamingHasher {
        ...
        protected void processRemaining(ByteBuffer buffer) {
            this.f32b += (long) buffer.remaining();
            int i = 0;
    ...
    public Hasher newHasher() {
        return new SipHasher(this.f30c, this.f31d, this.k0, this.k1);
    }

    public String toString() {
        return "Hashing.sipHash" + this.f30c + "" + this.f31d + "(" + this.k0 + ", " + this.k1 + ")";
    }
    ...
    public boolean equals(@Nullable Object object) {
        ...
        if (this.f30c == other.f30c && this.f31d == other.f31d && this.k0 == other.k0 && this.k1 == other.k1) {
            return true;
        }
        return false;
    }
    ...
    public int hashCode() {
        return (int) ((((long) ((getClass().hashCode() ^ this.f30c) ^ this.f31d)) ^ this.k0) ^ this.k1);
    }
}
