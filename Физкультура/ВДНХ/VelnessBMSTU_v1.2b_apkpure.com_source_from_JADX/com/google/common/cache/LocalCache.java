...
class LocalCache<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V> {
    ...
    static final Queue<? extends Object> DISCARDING_QUEUE = new C02942();
    static final int DRAIN_MAX = 16;
    static final int DRAIN_THRESHOLD = 63;
    static final int MAXIMUM_CAPACITY = 1073741824;
    static final int MAX_SEGMENTS = 65536;
    static final ValueReference<Object, Object> UNSET = new C05931();
    ...
    static class C02942 extends AbstractQueue<Object> {
        C02942() {
        }
    ...
    static final class AccessQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C09011();

        class C09011 extends AbstractReferenceEntry<K, V> {
    ...
    static final class WriteQueue<K, V> extends AbstractQueue<ReferenceEntry<K, V>> {
        final ReferenceEntry<K, V> head = new C09031();

        class C09031 extends AbstractReferenceEntry<K, V> {
    ...
    static class C05931 implements ValueReference<Object, Object> {
        C05931() {
        }
    ...
    static class LoadingValueReference<K, V> implements ValueReference<K, V> {
        ...
        class C06021 implements Function<V, V> {
            C06021() {
            }
        ...
        public ListenableFuture<V> loadFuture(K key, CacheLoader<? super K, V> loader) {
            ...
            if (previousValue == null) {
                ...
                ListenableFuture newValue2 = loader.reload(key, previousValue);
                if (newValue2 == null) {
                    return Futures.immediateFuture(null);
                }
                return Futures.transform(newValue2, new C06021());
            }
        }
