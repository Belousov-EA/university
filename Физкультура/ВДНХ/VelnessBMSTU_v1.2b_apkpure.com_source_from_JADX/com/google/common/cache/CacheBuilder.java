...
public final class CacheBuilder<K, V> {
    static final Supplier<StatsCounter> CACHE_STATS_COUNTER = new C05902();
    private static final int DEFAULT_CONCURRENCY_LEVEL = 4;
    private static final int DEFAULT_EXPIRATION_NANOS = 0;
    private static final int DEFAULT_INITIAL_CAPACITY = 16;
    private static final int DEFAULT_REFRESH_NANOS = 0;
    static final CacheStats EMPTY_STATS = new CacheStats(0, 0, 0, 0, 0, 0);
    static final Supplier<? extends StatsCounter> NULL_STATS_COUNTER = Suppliers.ofInstance(new C05891());
    static final Ticker NULL_TICKER = new C05913();
    ...
    static class C05891 implements StatsCounter {
        C05891() {
        }
    ...
    static class C05902 implements Supplier<StatsCounter> {
        C05902() {
        }
    ...
    static class C05913 extends Ticker {
        C05913() {
        }
