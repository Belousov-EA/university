...
public final class ClassPath {
    ...
    private static final Splitter CLASS_PATH_ATTRIBUTE_SEPARATOR = Splitter.on(MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR).omitEmptyStrings();
    private static final Predicate<ClassInfo> IS_TOP_LEVEL = new C07441();
    ...
    static class C07441 implements Predicate<ClassInfo> {
        C07441() {
        }
