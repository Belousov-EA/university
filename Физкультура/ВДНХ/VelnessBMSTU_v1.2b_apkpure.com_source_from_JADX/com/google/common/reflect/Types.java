...
final class Types {
    ...
    private static final Function<Type, String> TYPE_TO_STRING = new C07541();
    ...
    private enum ClassOwnership {
        ...
        static class C07583 extends AnonymousClass1LocalClass<String> {
            C07583() {
            }
        }
        ...
        private static ClassOwnership detectJvmBehavior() {
            ParameterizedType parameterizedType = (ParameterizedType) new C07583().getClass().getGenericSuperclass();
    ...
    enum JavaVersion {
        ...
        static class C07591 extends TypeCapture<int[]> {
            C07591() {
            }
        }
    ...
    static class C07541 implements Function<Type, String> {
        C07541() {
        }
