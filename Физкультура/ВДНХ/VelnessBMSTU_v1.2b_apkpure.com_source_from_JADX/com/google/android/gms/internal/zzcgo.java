            ...
            try {
                if (query.moveToFirst()) {
                    while (arrayList.size() < 1000) {
                        ...
                        if (zza == null) {
                            try {
                                zzawy().zzazd().zzd("(2)Read invalid user property value, ignoring it", zzchm.zzjk(str), string2, str3);
                            } catch (SQLiteException e2) {
                                e = e2;
                                cursor = query;
                                obj = string2;
            ...
            if (query.moveToFirst()) {
                ...
                do {
                    ...
                    try {
                        ...
                        zzawy().zzazd().zzd("Failed to merge filter results. appId, audienceId, error", zzchm.zzjk(str), Integer.valueOf(i), e3);
                    }
                } while (query.moveToNext());
                if (query == null) {
                    return arrayMap;
