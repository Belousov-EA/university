...
public final class zzdxm {
    ...
    public static FirebaseException zzao(Status status) {
        ...
        String zza = zza(zzgn(statusCode), status);
        switch (statusCode) {
            case 17000:
                return new FirebaseAuthInvalidCredentialsException(zzgm(statusCode), zza);
            case 17002:
            case 17004:
            case 17008:
            case 17009:
            ...
            case 17017:
            case 17021:
                return new FirebaseAuthInvalidUserException(zzgm(statusCode), zza);
            case 17006:
                return new FirebaseAuthException(zzgm(statusCode), zza);
            case 17007:
            case 17012:
            case 17025:
                return new FirebaseAuthUserCollisionException(zzgm(statusCode), zza);
            case 17010:
            ...
            case 17014:
                return new FirebaseAuthRecentLoginRequiredException(zzgm(statusCode), zza);
            case 17015:
            ...
            case 17026:
                return new FirebaseAuthWeakPasswordException(zzgm(statusCode), zza, status.getStatusMessage());
            case 17028:
                return new FirebaseAuthException(zzgm(statusCode), zza);
            case 17029:
            case 17030:
                return new FirebaseAuthActionCodeException(zzgm(statusCode), zza);
            case 17031:
            case 17032:
            case 17033:
                return new FirebaseAuthEmailException(zzgm(statusCode), zza);
            case 17034:
            case 17035:
            case 17041:
            case 17042:
