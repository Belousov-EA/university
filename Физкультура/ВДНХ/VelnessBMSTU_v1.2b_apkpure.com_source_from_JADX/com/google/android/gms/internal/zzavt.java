...
final class zzavt extends zzavw<Status> {
    ...
    zzavt(zzavp com_google_android_gms_internal_zzavp, GoogleApiClient googleApiClient, Credential credential) {
    ...
    protected final void zza(Context context, zzawd com_google_android_gms_internal_zzawd) throws RemoteException {
        com_google_android_gms_internal_zzawd.zza(new zzavv(this), new zzavz(this.zzegf));
    }
