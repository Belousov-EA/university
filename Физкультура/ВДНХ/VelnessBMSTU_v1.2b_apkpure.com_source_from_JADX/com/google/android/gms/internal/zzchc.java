...
public final class zzchc {
    ...
    public static zzchd<Integer> zzjbi = zzchd.zzm("measurement.audience.filter_result_max_count", 200, 200);
    public static zzchd<Long> zzjbj = zzchd.zzb("measurement.service_client.idle_disconnect_millis", 5000, 5000);
