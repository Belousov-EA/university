...
public abstract class zzfjm<M extends zzfjm<M>> extends zzfjs {
    ...
    public final <T> T zza(zzfjn<M, T> com_google_android_gms_internal_zzfjn_M__T) {
        if (this.zzpnc == null) {
            return null;
        }
        zzfjp zzmj = this.zzpnc.zzmj(com_google_android_gms_internal_zzfjn_M__T.tag >>> 3);
        return zzmj != null ? zzmj.zzb(com_google_android_gms_internal_zzfjn_M__T) : null;
    }
