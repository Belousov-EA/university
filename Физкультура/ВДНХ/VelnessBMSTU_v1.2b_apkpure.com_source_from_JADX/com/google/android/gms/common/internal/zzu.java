...
public final class zzu {
    ...
    public static String zzcn(Context context) {
        return context.getResources().getString(C0241R.string.common_google_play_services_notification_channel_name);
    }
    ...
    public static String zzg(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0241R.string.common_google_play_services_install_title);
            case 2:
                return resources.getString(C0241R.string.common_google_play_services_update_title);
            case 3:
                return resources.getString(C0241R.string.common_google_play_services_enable_title);
            case 4:
            case 6:
            case 18:
                return null;
    ...
    public static String zzh(Context context, int i) {
        ...
        return zzw == null ? context.getResources().getString(C0241R.string.common_google_play_services_notification_ticker) : zzw;
    }
    ...
    public static String zzi(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0241R.string.common_google_play_services_install_text, new Object[]{zzcm});
            case 2:
                if (zzi.zzct(context)) {
                    return resources.getString(C0241R.string.common_google_play_services_wear_update_text);
                }
                return resources.getString(C0241R.string.common_google_play_services_update_text, new Object[]{zzcm});
            case 3:
                return resources.getString(C0241R.string.common_google_play_services_enable_text, new Object[]{zzcm});
            case 5:
            ...
            case 9:
                return resources.getString(C0241R.string.common_google_play_services_unsupported_text, new Object[]{zzcm});
            case 16:
            ...
            case 18:
                return resources.getString(C0241R.string.common_google_play_services_updating_text, new Object[]{zzcm});
            case 20:
                return zzl(context, "common_google_play_services_restricted_profile_text", zzcm);
            default:
                return resources.getString(C0241R.string.common_google_play_services_unknown_issue, new Object[]{zzcm});
        }
    }
    ...
    public static String zzk(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(C0241R.string.common_google_play_services_install_button);
            case 2:
                return resources.getString(C0241R.string.common_google_play_services_update_button);
            case 3:
                return resources.getString(C0241R.string.common_google_play_services_enable_button);
            default:
    ...
    private static String zzl(Context context, String str, String str2) {
        ...
        if (zzw == null) {
            zzw = resources.getString(C0241R.string.common_google_play_services_unknown_issue);
        }
