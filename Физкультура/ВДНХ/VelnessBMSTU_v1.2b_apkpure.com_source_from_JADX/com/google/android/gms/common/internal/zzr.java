...
public final class zzr {
    ...
    public final Set<Scope> zzc(Api<?> api) {
        zzt com_google_android_gms_common_internal_zzt = (zzt) this.zzfzh.get(api);
        if (com_google_android_gms_common_internal_zzt == null || com_google_android_gms_common_internal_zzt.zzehs.isEmpty()) {
            return this.zzfmo;
        }
        Set<Scope> hashSet = new HashSet(this.zzfmo);
        hashSet.addAll(com_google_android_gms_common_internal_zzt.zzehs);
        return hashSet;
    }
