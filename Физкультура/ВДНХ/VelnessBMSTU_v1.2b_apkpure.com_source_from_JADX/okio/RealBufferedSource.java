...
final class RealBufferedSource implements BufferedSource {
    ...
    class C04231 extends InputStream {
        C04231() {
        }
    ...
    public String readUtf8LineStrict(long limit) throws IOException {
        ...
        if (scanLength < Long.MAX_VALUE && request(scanLength) && this.buffer.getByte(scanLength - 1) == Ascii.CR && request(1 + scanLength) && this.buffer.getByte(scanLength) == (byte) 10) {
