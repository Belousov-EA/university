...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    ...
    class C04201 extends OutputStream {
        C04201() {
        }
    ...
    class C04212 extends InputStream {
        C04212() {
        }
    ...
    public String readUtf8LineStrict(long limit) throws EOFException {
        ...
        if (scanLength < size() && getByte(scanLength - 1) == Ascii.CR && getByte(scanLength) == (byte) 10) {
    ...
    String readUtf8Line(long newline) throws EOFException {
        if (newline <= 0 || getByte(newline - 1) != Ascii.CR) {
