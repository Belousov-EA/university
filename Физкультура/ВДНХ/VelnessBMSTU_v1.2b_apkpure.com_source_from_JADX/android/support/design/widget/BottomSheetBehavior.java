...
public class BottomSheetBehavior<V extends View> extends Behavior<V> {
    ...
    private final Callback mDragCallback = new C04592();
    boolean mHideable;
    ...
    protected static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04601());
        final int state;

        static class C04601 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04601() {
            }
