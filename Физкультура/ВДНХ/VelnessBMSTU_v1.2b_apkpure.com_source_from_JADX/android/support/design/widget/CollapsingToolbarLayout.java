...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    class C04641 implements OnApplyWindowInsetsListener {
        C04641() {
        }
    ...
    class C04652 implements AnimatorUpdateListener {
        C04652() {
        }
    ...
    public CollapsingToolbarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C04641());
    }
    ...
    private void animateScrim(int targetAlpha) {
        ...
        if (this.mScrimAnimator == null) {
            ...
            this.mScrimAnimator.addUpdateListener(new C04652());
