...
public class BottomNavigationView extends FrameLayout {
    ...
    class C04571 implements Callback {
        C04571() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04581());
        Bundle menuPresenterState;

        static class C04581 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04581() {
            }
    ...
    public BottomNavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C04571());
    }
