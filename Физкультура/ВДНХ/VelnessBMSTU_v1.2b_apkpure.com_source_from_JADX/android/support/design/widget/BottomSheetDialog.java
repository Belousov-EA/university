...
public class BottomSheetDialog extends AppCompatDialog {
    ...
    class C04612 extends AccessibilityDelegateCompat {
        C04612() {
        }
    ...
    class C04623 extends BottomSheetCallback {
        C04623() {
        }
    ...
    public BottomSheetDialog(@NonNull Context context, @StyleRes int theme) {
        ...
        this.mBottomSheetCallback = new C04623();
    ...
    private View wrapInBottomSheet(int layoutResId, View view, LayoutParams params) {
        ...
        ViewCompat.setAccessibilityDelegate(bottomSheet, new C04612());
        return coordinator;
    }
