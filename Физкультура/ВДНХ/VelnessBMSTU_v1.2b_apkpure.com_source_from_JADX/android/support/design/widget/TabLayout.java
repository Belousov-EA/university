...
public class TabLayout extends HorizontalScrollView {
    ...
    private class SlidingTabStrip extends LinearLayout {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            if (MeasureSpec.getMode(widthMeasureSpec) == Ints.MAX_POWER_OF_TWO && TabLayout.this.mMode == 1 && TabLayout.this.mTabGravity == 1) {
                int i;
    ...
    class C04741 implements AnimatorUpdateListener {
        C04741() {
        }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (getChildCount() == 1) {
            ...
            if (remeasure) {
                child.measure(MeasureSpec.makeMeasureSpec(getMeasuredWidth(), Ints.MAX_POWER_OF_TWO), getChildMeasureSpec(heightMeasureSpec, getPaddingTop() + getPaddingBottom(), child.getLayoutParams().height));
            }
        }
    }
    ...
    private void ensureScrollAnimator() {
        if (this.mScrollAnimator == null) {
            ...
            this.mScrollAnimator.addUpdateListener(new C04741());
        }
    }
