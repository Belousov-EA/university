...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
    ...
    final Callback mManagerCallback = new C04533();
    ...
    class C04522 implements OnApplyWindowInsetsListener {
        C04522() {
        }
    ...
    class C04533 implements Callback {
        C04533() {
        }
    ...
    class C04544 implements OnDismissListener {
        C04544() {
        }
    ...
    class C04555 implements OnAttachStateChangeListener {
    ...
    class C04566 implements OnLayoutChangeListener {
        C04566() {
        }
    ...
    class C08467 extends ViewPropertyAnimatorListenerAdapter {
        C08467() {
        }
    ...
    protected BaseTransientBottomBar(@NonNull ViewGroup parent, @NonNull View content, @NonNull ContentViewCallback contentViewCallback) {
        if (parent == null) {
            ...
            ViewCompat.setOnApplyWindowInsetsListener(this.mView, new C04522());
    ...
    final void showView() {
        if (this.mView.getParent() == null) {
            ...
            if (lp instanceof CoordinatorLayout.LayoutParams) {
                ...
                behavior.setListener(new C04544());
                clp.setBehavior(behavior);
                clp.insetEdge = 80;
            }
            this.mTargetParent.addView(this.mView);
        }
        this.mView.setOnAttachStateChangeListener(new C04555());
        if (!ViewCompat.isLaidOut(this.mView)) {
            this.mView.setOnLayoutChangeListener(new C04566());
    ...
    void animateViewIn() {
        if (VERSION.SDK_INT >= 14) {
            ...
            ViewCompat.animate(this.mView).translationY(0.0f).setInterpolator(AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR).setDuration(250).setListener(new C08467()).start();
            return;
        }
