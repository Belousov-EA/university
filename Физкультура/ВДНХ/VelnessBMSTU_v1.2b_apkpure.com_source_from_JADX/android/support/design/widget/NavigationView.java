...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04721());
        public Bundle menuState;

        static class C04721 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04721() {
            }
    ...
    public NavigationView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenu.setCallback(new C04711());
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        switch (MeasureSpec.getMode(widthSpec)) {
            case Integer.MIN_VALUE:
                widthSpec = MeasureSpec.makeMeasureSpec(Math.min(MeasureSpec.getSize(widthSpec), this.mMaxWidth), Ints.MAX_POWER_OF_TWO);
                break;
            case 0:
                widthSpec = MeasureSpec.makeMeasureSpec(this.mMaxWidth, Ints.MAX_POWER_OF_TWO);
                break;
        }
