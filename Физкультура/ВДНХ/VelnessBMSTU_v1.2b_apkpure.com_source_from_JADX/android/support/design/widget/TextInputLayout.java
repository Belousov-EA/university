...
public class TextInputLayout extends LinearLayout {
    ...
    class C04765 implements AnimatorUpdateListener {
        C04765() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C04771());
        CharSequence error;

        static class C04771 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C04771() {
            }
    ...
    class C08502 extends ViewPropertyAnimatorListenerAdapter {
        C08502() {
        }
    ...
    private void setError(@Nullable final CharSequence error, boolean animate) {
        ...
        if (this.mErrorShown) {
            ...
            if (animate) {
                ...
                ViewCompat.animate(this.mErrorView).alpha(1.0f).setDuration(200).setInterpolator(AnimationUtils.LINEAR_OUT_SLOW_IN_INTERPOLATOR).setListener(new C08502()).start();
            } else {
    ...
    void animateToExpansionFraction(float target) {
        if (this.mCollapsingTextHelper.getExpansionFraction() != target) {
            if (this.mAnimator == null) {
                ...
                this.mAnimator.addUpdateListener(new C04765());
            }
