...
public class ParcelableSparseArray extends SparseArray<Parcelable> implements Parcelable {
    public static final Creator<ParcelableSparseArray> CREATOR = ParcelableCompat.newCreator(new C04471());

    static class C04471 implements ParcelableCompatCreatorCallbacks<ParcelableSparseArray> {
        C04471() {
        }
