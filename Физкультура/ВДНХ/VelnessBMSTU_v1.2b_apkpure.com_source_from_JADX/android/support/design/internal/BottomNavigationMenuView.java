...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int heightSpec = MeasureSpec.makeMeasureSpec(this.mItemHeight, Ints.MAX_POWER_OF_TWO);
        int extra;
        int i2;
        int[] iArr;
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                child.measure(MeasureSpec.makeMeasureSpec(this.mTempChildWidths[i], Ints.MAX_POWER_OF_TWO), heightSpec);
                child.getLayoutParams().width = child.getMeasuredWidth();
                totalWidth += child.getMeasuredWidth();
            }
        }
        setMeasuredDimension(ViewCompat.resolveSizeAndState(totalWidth, MeasureSpec.makeMeasureSpec(totalWidth, Ints.MAX_POWER_OF_TWO), 0), ViewCompat.resolveSizeAndState(this.mItemHeight, heightSpec, 0));
    }
