                ...
                if (!(widget instanceof Guideline)) {
                    ...
                    if (!(child == null || child.getVisibility() == 8)) {
                        ...
                        if (params.width == -2) {
                            ...
                            widthSpec = MeasureSpec.makeMeasureSpec(widget.getWidth(), Ints.MAX_POWER_OF_TWO);
                        }
                        if (params.height == -2) {
                            heightSpec = getChildMeasureSpec(heightMeasureSpec, heightPadding, params.height);
                        } else {
                            heightSpec = MeasureSpec.makeMeasureSpec(widget.getHeight(), Ints.MAX_POWER_OF_TWO);
                        }
