...
public class ViewPager extends ViewGroup {
    ...
    class C05114 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05121());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        static class C05121 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05121() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C05114());
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        this.mChildWidthMeasureSpec = MeasureSpec.makeMeasureSpec(childWidthSize, Ints.MAX_POWER_OF_TWO);
        this.mChildHeightMeasureSpec = MeasureSpec.makeMeasureSpec(childHeightSize, Ints.MAX_POWER_OF_TWO);
        this.mInLayout = true;
        populate();
        ...
        for (i = 0; i < size; i++) {
            ...
            if (child.getVisibility() != 8) {
                lp = (LayoutParams) child.getLayoutParams();
                if (lp == null || !lp.isDecor) {
                    child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), Ints.MAX_POWER_OF_TWO), this.mChildHeightMeasureSpec);
                }
            }
        }
    }
                ...
                if (!lp.isDecor) {
                    ...
                    if (ii != null) {
                        ...
                        if (lp.needsMeasure) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec((int) (((float) childWidth) * lp.widthFactor), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec((height - paddingTop) - paddingBottom, Ints.MAX_POWER_OF_TWO));
                        }
                        child.layout(childLeft, childTop, child.getMeasuredWidth() + childLeft, child.getMeasuredHeight() + childTop);
                    }
                }
