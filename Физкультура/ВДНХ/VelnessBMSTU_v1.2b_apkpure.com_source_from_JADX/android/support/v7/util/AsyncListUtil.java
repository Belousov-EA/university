...
public class AsyncListUtil<T> {
    ...
    private final BackgroundCallback<T> mBackgroundCallback = new C05312();
    final BackgroundCallback<T> mBackgroundProxy;
    final DataCallback<T> mDataCallback;
    int mDisplayedGeneration = 0;
    int mItemCount = 0;
    private final MainThreadCallback<T> mMainThreadCallback = new C05301();
    ...
    class C05301 implements MainThreadCallback<T> {
        C05301() {
        }
    ...
    class C05312 implements BackgroundCallback<T> {
