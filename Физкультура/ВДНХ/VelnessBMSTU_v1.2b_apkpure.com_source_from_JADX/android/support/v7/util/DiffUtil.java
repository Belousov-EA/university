...
public class DiffUtil {
    private static final Comparator<Snake> SNAKE_COMPARATOR = new C01821();

    static class C01821 implements Comparator<Snake> {
        C01821() {
        }
                ...
                for (int i = count - 1; i >= 0; i--) {
                    ...
                    switch (status) {
                        ...
                        case 16:
                            ...
                            break;
                        default:
                            throw new IllegalStateException("unknown flag for pos " + (globalIndex + i) + MinimalPrettyPrinter.DEFAULT_ROOT_VALUE_SEPARATOR + Long.toBinaryString((long) status));
                    }
                }
                return;
            }
