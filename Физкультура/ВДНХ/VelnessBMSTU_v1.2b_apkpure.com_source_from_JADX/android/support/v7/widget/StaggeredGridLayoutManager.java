...
public class StaggeredGridLayoutManager extends LayoutManager implements ScrollVectorProvider {
    ...
    private final Runnable mCheckForGapsRunnable = new C02241();
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            public static final Creator<FullSpanItem> CREATOR = new C02251();
            int mGapDir;
            int[] mGapPerSpan;
            boolean mHasUnwantedGapAfter;
            int mPosition;

            static class C02251 implements Creator<FullSpanItem> {
                C02251() {
                }
    ...
    public static class SavedState implements Parcelable {
        ...
        static class C02261 implements Creator<SavedState> {
            C02261() {
            }
