...
public class ListPopupWindow implements ShowableListMenu {
    ...
    class C02093 implements OnItemSelectedListener {
        C02093() {
        }
    ...
    private int buildDropDown() {
        ...
        if (this.mDropDownList == null) {
            ...
            this.mShowDropDownRunnable = new C02082();
            ...
            this.mDropDownList.setOnItemSelectedListener(new C02093());
        ...
        switch (this.mDropDownWidth) {
            case -2:
                ...
                break;
            case -1:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mContext.getResources().getDisplayMetrics().widthPixels - (this.mTempRect.left + this.mTempRect.right), Ints.MAX_POWER_OF_TWO);
                break;
            default:
                childWidthSpec = MeasureSpec.makeMeasureSpec(this.mDropDownWidth, Ints.MAX_POWER_OF_TWO);
                break;
        }
