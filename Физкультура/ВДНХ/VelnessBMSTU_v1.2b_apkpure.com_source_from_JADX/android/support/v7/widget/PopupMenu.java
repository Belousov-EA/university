...
public class PopupMenu {
    ...
    class C02102 implements android.widget.PopupWindow.OnDismissListener {
        C02102() {
        }
    ...
    class C05431 implements Callback {
        C05431() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C05431());
        ...
        this.mPopup.setOnDismissListener(new C02102());
    }
