...
public class LinearLayoutCompat extends ViewGroup {
    ...
    public LinearLayoutCompat(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mWeightSum = a.getFloat(C0180R.styleable.LinearLayoutCompat_android_weightSum, GroundOverlayOptions.NO_DIMENSION);
                ...
                if (child.getVisibility() != 8) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.height == 0 && heightMode == 1073741824) {
                            ...
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(share, Ints.MAX_POWER_OF_TWO));
                        } else {
                            childHeight = child.getMeasuredHeight() + share;
                            if (childHeight < 0) {
                                childHeight = 0;
                            }
                            child.measure(childWidthMeasureSpec, MeasureSpec.makeMeasureSpec(childHeight, Ints.MAX_POWER_OF_TWO));
                        }
            ...
            if (useLargestChild && heightMode != 1073741824) {
                for (i = 0; i < count; i++) {
                    ...
                    if (!(child == null || child.getVisibility() == 8 || ((LayoutParams) child.getLayoutParams()).weight <= 0.0f)) {
                        child.measure(MeasureSpec.makeMeasureSpec(child.getMeasuredWidth(), Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(largestChildHeight, Ints.MAX_POWER_OF_TWO));
                    }
                }
            }
        }
        ...
        if (skippedMeasure || (delta != 0 && totalWeight > 0.0f)) {
                ...
                if (!(child == null || child.getVisibility() == 8)) {
                    ...
                    if (childExtra > 0.0f) {
                        ...
                        if (lp.width == 0 && widthMode == 1073741824) {
                            ...
                            child.measure(MeasureSpec.makeMeasureSpec(share, Ints.MAX_POWER_OF_TWO), childHeightMeasureSpec);
                        } else {
                            childWidth = child.getMeasuredWidth() + share;
                            if (childWidth < 0) {
                                childWidth = 0;
                            }
                            child.measure(MeasureSpec.makeMeasureSpec(childWidth, Ints.MAX_POWER_OF_TWO), childHeightMeasureSpec);
                        }
            ...
            if (useLargestChild && widthMode != 1073741824) {
                for (i = 0; i < count; i++) {
                    child = getVirtualChildAt(i);
                    if (!(child == null || child.getVisibility() == 8 || ((LayoutParams) child.getLayoutParams()).weight <= 0.0f)) {
                        child.measure(MeasureSpec.makeMeasureSpec(largestChildWidth, Ints.MAX_POWER_OF_TWO), MeasureSpec.makeMeasureSpec(child.getMeasuredHeight(), Ints.MAX_POWER_OF_TWO));
                    }
                }
            }
        }
