...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    ...
    class C08641 extends ViewPropertyAnimatorListenerAdapter {
        C08641() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C08641();
        this.mRemoveActionBarHideOffset = new C01912();
        this.mAddActionBarHideOffset = new C01923();
        init(context);
