...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C02173 implements Runnable {
        C02173() {
        }
    ...
    class C02184 implements OnFocusChangeListener {
        C02184() {
        }
    ...
    class C02195 implements OnLayoutChangeListener {
        C02195() {
        }
    ...
    class C02206 implements OnGlobalLayoutListener {
        C02206() {
        }
    ...
    class C02228 implements OnKeyListener {
        C02228() {
        }
    ...
    class C02239 implements OnEditorActionListener {
        C02239() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05521());
        boolean isIconified;

        static class C05521 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05521() {
            }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C02151();
        this.mUpdateDrawableStateRunnable = new C02162();
        this.mReleaseCursorRunnable = new C02173();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C02217();
        this.mTextKeyListener = new C02228();
        this.mOnEditorActionListener = new C02239();
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C02184());
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C02195());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C02206());
    }
    ...
    private Intent createVoiceAppSearchIntent(Intent baseIntent, SearchableInfo searchable) {
        ...
        PendingIntent pending = PendingIntent.getActivity(getContext(), 0, queryIntent, Ints.MAX_POWER_OF_TWO);
