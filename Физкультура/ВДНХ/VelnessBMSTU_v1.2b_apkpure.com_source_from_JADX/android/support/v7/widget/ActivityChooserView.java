...
public class ActivityChooserView extends ViewGroup implements ActivityChooserModelClient {
    ...
    class C01952 implements OnGlobalLayoutListener {
        C01952() {
        }
    ...
    class C01964 extends DataSetObserver {
        C01964() {
        }
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        this.mModelDataSetObserver = new C01941();
        this.mOnGlobalLayoutListener = new C01952();
        ...
        this.mAdapter.registerDataSetObserver(new C01964());
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mDefaultActivityButton.getVisibility() != 0) {
            heightMeasureSpec = MeasureSpec.makeMeasureSpec(MeasureSpec.getSize(heightMeasureSpec), Ints.MAX_POWER_OF_TWO);
        }
