...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new C05562();
    View mOverdrawChild = null;
    int mOverdrawChildPosition = -1;
    final List<View> mPendingCleanup = new ArrayList();
    List<RecoverAnimation> mRecoverAnimations = new ArrayList();
    RecyclerView mRecyclerView;
    final Runnable mScrollRunnable = new C02311();
    ...
    public static abstract class Callback {
        ...
        private static final Interpolator sDragScrollInterpolator = new C02331();
        private static final Interpolator sDragViewScrollCapInterpolator = new C02342();
        private static final ItemTouchUIUtil sUICallback;
        private int mCachedMaxScrollSpeed = -1;

        static class C02331 implements Interpolator {
            C02331() {
            }
        ...
        static class C02342 implements Interpolator {
            C02342() {
            }
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0181R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    class C05562 implements OnItemTouchListener {
        C05562() {
        }
    ...
    class C05575 implements ChildDrawingOrderCallback {
        C05575() {
        }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        if (this.mRecyclerView != recyclerView) {
            ...
            if (this.mRecyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0181R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0181R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    private void addChildDrawingOrderCallback() {
        if (VERSION.SDK_INT < 21) {
            if (this.mChildDrawingOrderCallback == null) {
                this.mChildDrawingOrderCallback = new C05575();
            }
