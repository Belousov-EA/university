...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, C0180R.styleable.ActionBar);
        this.mBackground = a.getDrawable(C0180R.styleable.ActionBar_background);
        this.mStackedBackground = a.getDrawable(C0180R.styleable.ActionBar_backgroundStacked);
        this.mHeight = a.getDimensionPixelSize(C0180R.styleable.ActionBar_height, -1);
        if (getId() == C0180R.id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = a.getDrawable(C0180R.styleable.ActionBar_backgroundSplit);
        }
        a.recycle();
        if (this.mIsSplit) {
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0180R.id.action_bar);
        this.mContextView = findViewById(C0180R.id.action_context_bar);
    }
    ...
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.mActionBarView != null) {
            ...
            if (this.mTabContainer != null && this.mTabContainer.getVisibility() != 8 && mode != Ints.MAX_POWER_OF_TWO) {
