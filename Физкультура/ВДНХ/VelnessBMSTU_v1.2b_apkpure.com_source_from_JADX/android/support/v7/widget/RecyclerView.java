...
import android.support.v7.recyclerview.C0181R;
...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    static final Interpolator sQuinticInterpolator = new C02133();
    ...
    static class C02133 implements Interpolator {
        C02133() {
        }
    ...
    public static abstract class LayoutManager {
        ...
        private final Callback mHorizontalBoundCheckCallback = new C05481();
        ...
        private final Callback mVerticalBoundCheckCallback = new C05492();
        private int mWidth;
        ...
        class C05481 implements Callback {
            C05481() {
            }
        ...
        class C05492 implements Callback {
            C05492() {
            }
        ...
        public static int getChildMeasureSpec(int parentSize, int parentMode, int padding, int childDimension, boolean canScroll) {
            ...
            if (canScroll) {
                ...
                resultSize = size;
                resultMode = (parentMode == Integer.MIN_VALUE || parentMode == Ints.MAX_POWER_OF_TWO) ? Integer.MIN_VALUE : 0;
            }
            return MeasureSpec.makeMeasureSpec(resultSize, resultMode);
        }
        ...
        public static Properties getProperties(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, C0181R.styleable.RecyclerView, defStyleAttr, defStyleRes);
            properties.orientation = a.getInt(C0181R.styleable.RecyclerView_android_orientation, 1);
            properties.spanCount = a.getInt(C0181R.styleable.RecyclerView_spanCount, 1);
            properties.reverseLayout = a.getBoolean(C0181R.styleable.RecyclerView_reverseLayout, false);
            properties.stackFromEnd = a.getBoolean(C0181R.styleable.RecyclerView_stackFromEnd, false);
            a.recycle();
            return properties;
        }
    ...
    class C05454 implements ProcessCallback {
        C05454() {
        }
    ...
    class C05465 implements Callback {
        C05465() {
        }
    ...
    class C05476 implements Callback {
        C05476() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05501());
        Parcelable mLayoutState;

        static class C05501 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C05501() {
            }
    ...
    public RecyclerView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        this.mUpdateChildViewsRunnable = new C02111();
        ...
        this.mItemAnimatorRunner = new C02122();
        this.mViewInfoProcessCallback = new C05454();
        if (attrs != null) {
        ...
        if (attrs != null) {
            a = context.obtainStyledAttributes(attrs, C0181R.styleable.RecyclerView, defStyle, 0);
            String layoutManagerName = a.getString(C0181R.styleable.RecyclerView_layoutManager);
            if (a.getInt(C0181R.styleable.RecyclerView_android_descendantFocusability, -1) == -1) {
    ...
    private void initChildrenHelper() {
        this.mChildHelper = new ChildHelper(new C05465());
    }

    void initAdapterManager() {
        this.mAdapterHelper = new AdapterHelper(new C05476());
    }
