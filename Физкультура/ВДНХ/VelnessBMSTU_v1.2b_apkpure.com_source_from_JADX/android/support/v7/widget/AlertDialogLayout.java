    ...
    private boolean tryOnMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != 8) {
                int id = child.getId();
                if (id == C0180R.id.topPanel) {
                    topPanel = child;
                } else if (id == C0180R.id.buttonPanel) {
                    buttonPanel = child;
                } else if (id != C0180R.id.contentPanel && id != C0180R.id.customPanel) {
                    return false;
                } else {
                    if (middlePanel != null) {
                        return false;
        ...
        if (buttonPanel != null) {
            ...
            buttonPanel.measure(widthMeasureSpec, MeasureSpec.makeMeasureSpec(buttonHeight, Ints.MAX_POWER_OF_TWO));
