...
public class Toolbar extends ViewGroup {
    ...
    class C05541 implements android.support.v7.widget.ActionMenuView.OnMenuItemClickListener {
        C05541() {
        }
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05551());
    ...
    public Toolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        this.mMenuViewItemClickListener = new C05541();
        this.mShowOverflowMenuRunnable = new C02282();
    ...
    void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            ...
            this.mCollapseButtonView.setOnClickListener(new C02293());
        }
    }
