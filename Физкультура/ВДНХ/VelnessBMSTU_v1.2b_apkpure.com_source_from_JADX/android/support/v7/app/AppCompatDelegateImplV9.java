...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01775 implements Runnable {
        ...
        class C08581 extends ViewPropertyAnimatorListenerAdapter {
            C08581() {
            }
        ...
        public void run() {
            ...
            if (AppCompatDelegateImplV9.this.shouldAnimateActionModeView()) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C08581());
                return;
            }
            ViewCompat.setAlpha(AppCompatDelegateImplV9.this.mActionModeView, 1.0f);
            AppCompatDelegateImplV9.this.mActionModeView.setVisibility(0);
    ...
    protected static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C05271());
            int featureId;
            boolean isOpen;
            Bundle menuState;

            static class C05271 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C05271() {
                }
    ...
    class C05242 implements OnApplyWindowInsetsListener {
        C05242() {
        }
    ...
    class C05253 implements OnFitSystemWindowsListener {
        C05253() {
        }
    ...
    class C05264 implements OnAttachListener {
        C05264() {
        }
    ...
    class ActionModeCallbackWrapperV9 implements ActionMode.Callback {
        ...
        class C08601 extends ViewPropertyAnimatorListenerAdapter {
            C08601() {
            }
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV9.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV9.this.mFadeAnim.setListener(new C08601());
            }
    ...
    class C08596 extends ViewPropertyAnimatorListenerAdapter {
        C08596() {
        }
        ...
        if (a.hasValue(C0180R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C05242());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C05253());
                }
            ...
            contentView.setAttachListener(new C05264());
            return subDecor;
        }
        a.recycle();
            ...
            if (this.mActionModeView != null) {
                ...
                if (callback.onCreateActionMode(mode, mode.getMenu())) {
                    ...
                    if (shouldAnimateActionModeView()) {
                        ...
                        this.mFadeAnim.setListener(new C08596());
                    } else {
