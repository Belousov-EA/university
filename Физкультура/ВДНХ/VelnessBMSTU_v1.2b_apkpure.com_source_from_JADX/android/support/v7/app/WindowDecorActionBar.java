...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C08611();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C08622();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C05293();

    class C05293 implements ViewPropertyAnimatorUpdateListener {
        C05293() {
        }
    ...
    class C08611 extends ViewPropertyAnimatorListenerAdapter {
        C08611() {
        }
    ...
    class C08622 extends ViewPropertyAnimatorListenerAdapter {
        C08622() {
        }
