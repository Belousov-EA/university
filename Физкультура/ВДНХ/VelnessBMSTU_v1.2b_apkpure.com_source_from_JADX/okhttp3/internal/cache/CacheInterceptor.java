...
public final class CacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        try {
            ...
            if (cacheResponse != null) {
                if (networkResponse.code() == HttpStatusCodes.STATUS_CODE_NOT_MODIFIED) {
    ...
    private static Headers combine(Headers cachedHeaders, Headers networkHeaders) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (!(com.google.common.net.HttpHeaders.WARNING.equalsIgnoreCase(fieldName) && value.startsWith("1")) && (!isEndToEnd(fieldName) || networkHeaders.get(fieldName) == null)) {
        ...
        for (i = 0; i < size; i++) {
            ...
            if (!com.google.common.net.HttpHeaders.CONTENT_LENGTH.equalsIgnoreCase(fieldName) && isEndToEnd(fieldName)) {
    ...
    static boolean isEndToEnd(String fieldName) {
        if (com.google.common.net.HttpHeaders.CONNECTION.equalsIgnoreCase(fieldName) || "Keep-Alive".equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.PROXY_AUTHENTICATE.equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.PROXY_AUTHORIZATION.equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.TE.equalsIgnoreCase(fieldName) || "Trailers".equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.TRANSFER_ENCODING.equalsIgnoreCase(fieldName) || com.google.common.net.HttpHeaders.UPGRADE.equalsIgnoreCase(fieldName)) {
            return false;
        }
        return true;
    }
