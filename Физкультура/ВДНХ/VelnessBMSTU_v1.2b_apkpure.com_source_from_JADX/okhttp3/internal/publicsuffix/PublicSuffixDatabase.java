...
*/
    ...
    L_0x0010:
        ...
        r5 = r0.readInt();	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r4 = new byte[r5];	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r0.readFully(r4);	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r6 = r0.readInt();	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r3 = new byte[r6];	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r0.readFully(r3);	 Catch:{ IOException -> 0x003e, all -> 0x004f }
    ...
    L_0x003e:
        r1 = move-exception;
        r7 = okhttp3.internal.platform.Platform.get();	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r8 = 5;	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r9 = "Failed to read public suffix list";	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r7.log(r8, r9, r1);	 Catch:{ IOException -> 0x003e, all -> 0x004f }
        r4 = 0;
        r3 = 0;
        okhttp3.internal.Util.closeQuietly(r0);
        goto L_0x0032;
