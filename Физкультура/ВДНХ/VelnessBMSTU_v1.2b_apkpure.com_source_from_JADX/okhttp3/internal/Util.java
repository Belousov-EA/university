...
public final class Util {
    ...
    public static final Comparator<String> NATURAL_ORDER = new C04131();
    ...
    class C04131 implements Comparator<String> {
        C04131() {
        }
    ...
    class C04142 implements ThreadFactory {
        final /* synthetic */ boolean val$daemon;
        final /* synthetic */ String val$name;

        C04142(String str, boolean z) {
            this.val$name = str;
            this.val$daemon = z;
        }
