...
public final class Cache implements Closeable, Flushable {
    ...
    class C04092 implements Iterator<String> {
        boolean canRemove;
        final Iterator<Snapshot> delegate = Cache.this.cache.snapshots();
        String nextUrl;

        C04092() throws IOException {
        }
    ...
    private static final class Entry {
        ...
        public Response response(Snapshot snapshot) {
            String contentType = this.responseHeaders.get(com.google.common.net.HttpHeaders.CONTENT_TYPE);
            String contentLength = this.responseHeaders.get(com.google.common.net.HttpHeaders.CONTENT_LENGTH);
    ...
    class C08051 implements InternalCache {
        C08051() {
        }
    ...
    CacheRequest put(Response response) {
        ...
        } else if (!requestMethod.equals(HttpMethods.GET) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
